...
class Master extends CI_Controller {
    ...
    public function remote($type,$id=null,$column='name')
    {
        ...
        elseif ($type=='book_condition') {
            $tb ='book_condition_master';
        }
        elseif ($type=='flavour') {
            $tb ='flavour_master';
        }
        ...
        switch ($action) {
            case null:
                ...
                case 'tb':
                    ...
                    if (@$_POST['classv']) {
                        $classv = $_POST['classv'];
                        $data['classv'] = $_POST['classv'];
                    }

                    if (@$_POST['subjectv']) {
                        $subjectv = $_POST['subjectv'];
                        $data['subjectv'] = $_POST['subjectv'];
                    }
                    ...
                    $config["total_rows"]       = $this->master_model->products($parent_id,$pro_id,$cat_id,$child_cat_id,$search,$classv,$subjectv);
                    ...
                    $data['products']           = $this->master_model->products($parent_id,$pro_id,$cat_id,$child_cat_id,$search,$classv,$subjectv,$config["per_page"],$page);
                    ...
                    $data['class']          = $this->master_model->get_data('class_master','active','1');
                    $data['subject']          = $this->master_model->get_data('subject_master','active','1');
            ...
            case 'find_author':
                ...
                $data = $this->master_model->get_author($author);
                echo json_encode($data);
                break;

            case 'find_publisher':
                $publisher = $this->input->post('publisher');
                $data = $this->master_model->get_publisher($publisher);
                echo json_encode($data);
                break;

            case 'vendor_list':
                $shop_id = $this->input->post('shop_id');
                $data = $this->master_model->getData('vendors',['active'=>1, 'is_deleted'=>'NOT_DELETED', 'shop_id'=>$shop_id]);
                echo json_encode($data);
                break;
            ...
            case 'create':
                ...
                if ($p1!=null) {
                    ...
                    $author          = $this->master_model->get_data('author','active','1');
                    foreach($author as $row){
                        if ($data['value']->author_id == $row->id) {
                            $data['author'] = $row->name;
                        }
                    }

                    $publisher          = $this->master_model->get_data('publisher','active','1');
                    foreach($publisher as $row){
                        if ($data['value']->publisher_id == $row->id) {
                            $data['publisher'] = $row->name;
                        }
                    }

                    $data['shops_inventory'] = $this->master_model->get_data2_row('shops_inventory',['product_id'=>$data['value']->id]);
                    $data['shops'] = $this->master_model->get_data2_row('shops',['id'=>$data['shops_inventory']->shop_id]);
                    $data['vendor'] = $this->master_model->getData('vendors',['active'=>1, 'is_deleted'=>'NOT_DELETED']);
                ...
                $data['brands']          = $this->master_model->get_data('brand_master','active','1');                
                 ...
                 $data['board']          = $this->master_model->getData('board_master',['is_deleted' => 'NOT_DELETED','active'=>'1'],'asc','name');
          
                $data['class']          = $this->master_model->getData('class_master',['is_deleted' => 'NOT_DELETED','active'=>'1'],'asc','seq');
          
                $data['subject']          = $this->master_model->getData('subject_master',['is_deleted' => 'NOT_DELETED','active'=>'1'],'asc','name');
          
                $data['binding']          = $this->master_model->getData('binding_master',['is_deleted' => 'NOT_DELETED','active'=>'1'],'asc','name');
                
                $data['book_condition']          = $this->master_model->get_data('book_condition_master','active','1');
                ...
                case 'duplicate':
                    ...
                    $data['unit_type']          = $this->master_model->get_data('unit_master','active','1');
                    $data['brands']          = $this->master_model->get_data('brand_master','active','1');
                    //$data['author']          = $this->master_model->get_data('author','active','1');
                    //$data['publisher']          = $this->master_model->get_data('publisher','active','1');
                    $data['board']          = $this->master_model->get_data('board_master','active','1');
                    $data['class']          = $this->master_model->get_data('class_master','active','1');
                    $data['subject']          = $this->master_model->get_data('subject_master','active','1');
                    $data['binding']          = $this->master_model->get_data('binding_master','active','1');
                    $data['book_condition']          = $this->master_model->get_data('book_condition_master','active','1');
                    $data['flavours']          = $this->master_model->get_data('flavour_master','active','1');
            ...
            case 'update_prod_seq':
                ...
                case 'save':
                    ...
                    if ($this->input->server('REQUEST_METHOD')=='POST') {
                        $publisher = $this->input->post('publisher');
                        $publisher_query = $this->master_model->get_data2_row('publisher',['name'=>$publisher, 'active'=>1, 'is_deleted'=>'NOT_DELETED']);
                        if ($publisher_query == TRUE) {
                            $publisher_id = $publisher_query->id;
                        }else{
                            $data = array('name'=>$publisher);
                            $this->master_model->add_data('publisher',$data);
                            $publisher_id = $this->db->insert_id();
                        }

                        $author = $this->input->post('author');
                        $query = $this->master_model->get_data2_row('author',['name'=>$author, 'active'=>1, 'is_deleted'=>'NOT_DELETED']);
                        if ($query == TRUE) {
                            $author_id = $query->id;
                        }else{
                            $data = array('name'=>$author);
                            $this->master_model->add_data('author',$data);
                         ...
                         if ($id!=null) {
                            ...
                            $data = array(
                                    ...
                                    'binding_id'        => $this->input->post('binding'),
                                    'book_condition_id' => $this->input->post('book_condition'),
                                );
                            if($this->master_model->edit_product($data,$id)){
                                ...
                                if (!empty($shop_inventry_id)) {
                                    $data_shop_inventry = array(
                                        ...
                                        'vendor_id'=>$this->input->post('s_vendor'),
                                        'mrp'=>$this->input->post('s_mrp'),
    ...
    {
        $data['menu_id'] = $this->uri->segment(2);
        $data['title']      = 'Author Master';
        $data['authors']      = $this->master_model->getData('author',['is_deleted'=>'NOT_DELETED'],'ASC','name');
        $data['remote']     = base_url().'master-data/remote/author/';
        $page               = 'admin/master/author_master';
        $this->header_and_footer($page, $data);
    }
    public function add_author()
    {
        ...
        if ($this->master_model->add_data('author',$data)) {
    ...
    public function edit_author()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->edit_data('author',$id,$data)) {
            $this->session->set_flashdata('success', 'Author Edited Successfully');
            redirect($this->agent->referrer());
        } else {
            redirect($this->agent->referrer());
        }
    ...
    {
        $id = $this->uri->segment(2);
        if ($this->master_model->delete_data('author',$id)) {
    ...
    {
        $id = $this->input->post('id');
        $data['status_data'] = $this->master_model->get_row_data('author','id',$id);
        ...
        $this->master_model->edit_data('author',$id,$data1);
        $this->load->view('admin/statusview',$data);
        
    }

    // Publisher Master
    public function publisher_master()
    {
        $data['menu_id'] = $this->uri->segment(2);
        $data['title']      = 'Publisher Master';
        $data['publisher']      = $this->master_model->getData('publisher',['is_deleted'=>'NOT_DELETED'],'ASC','name');
        $data['remote']     = base_url().'master-data/remote/publisher/';
        $page               = 'admin/master/publisher_master';
        $this->header_and_footer($page, $data);
    }
    public function add_publisher()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->add_data('publisher',$data)) {
    ...
    public function edit_publisher()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->edit_data('publisher',$id,$data)) {
    ...
    {
        $id = $this->uri->segment(2);
        if ($this->master_model->delete_data('publisher',$id)) {
    ...
    public function change_publisher_status()
    {
        $id = $this->input->post('id');
        $data['status_data'] = $this->master_model->get_row_data('publisher','id',$id);
        ...
        $this->master_model->edit_data('publisher',$id,$data1);
        $this->load->view('admin/statusview',$data);
        
    }

    // Board Master
    public function board_master()
    {
        $data['menu_id'] = $this->uri->segment(2);
        $data['title']      = 'Board Master';
        $data['board']      = $this->master_model->getData('board_master',['is_deleted'=>'NOT_DELETED'],'ASC','name');
        $data['remote']     = base_url().'master-data/remote/board/';
        $page               = 'admin/master/board_master';
        $this->header_and_footer($page, $data);
    }
    public function add_board()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->add_data('board_master',$data)) {
    ...
    public function edit_board()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->edit_data('board_master',$id,$data)) {
            $this->session->set_flashdata('success', 'Board Edited Successfully');
            redirect($this->agent->referrer());
        } else {
            redirect($this->agent->referrer());
        }
    ...
    {
        $id = $this->uri->segment(2);
        if ($this->master_model->delete_data('board_master',$id)) {
    ...
    public function change_board_status()
    {
        $id = $this->input->post('id');
        $data['status_data'] = $this->master_model->get_row_data('board_master','id',$id);
        ...
        $this->master_model->edit_data('board_master',$id,$data1);
        $this->load->view('admin/statusview',$data);
    ...
    public function class_master()
    {
        ...
        $data['class']      = $this->master_model->getData('class_master',['is_deleted'=>'NOT_DELETED'],'ASC','name');
        $data['remote']     = base_url().'master-data/remote/class/';
        $page               = 'admin/master/class_master';
        $this->header_and_footer($page, $data);
    }
    public function add_class()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->add_data('class_master',$data)) {
    ...
    public function edit_class()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->edit_data('class_master',$id,$data)) {
    ...
    {
        $id = $this->uri->segment(2);
        if ($this->master_model->delete_data('class_master',$id)) {
    ...
    {
        $id = $this->input->post('id');
        $data['status_data'] = $this->master_model->get_row_data('class_master','id',$id);
        ...
        $this->master_model->edit_data('class_master',$id,$data1);
        $this->load->view('admin/statusview',$data);
    ...
    public function subject_master()
    {
        ...
        $data['subject']      = $this->master_model->getData('subject_master',['is_deleted'=>'NOT_DELETED'],'ASC','name');
        $data['remote']     = base_url().'master-data/remote/subject/';
        $page               = 'admin/master/subject_master';
        $this->header_and_footer($page, $data);
    }
    public function add_subject()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->add_data('subject_master',$data)) {
    ...
    public function edit_subject()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->edit_data('subject_master',$id,$data)) {
    ...
    {
        $id = $this->uri->segment(2);
        if ($this->master_model->delete_data('subject_master',$id)) {
    ...
    {
        $id = $this->input->post('id');
        $data['status_data'] = $this->master_model->get_row_data('subject_master','id',$id);
        ...
        $this->master_model->edit_data('subject_master',$id,$data1);
        $this->load->view('admin/statusview',$data);
        
    }

    // Subject Master
    public function binding_master()
    {
        $data['menu_id'] = $this->uri->segment(2);
        $data['title']      = 'Binding Master';
        $data['binding']      = $this->master_model->getData('binding_master',['is_deleted'=>'NOT_DELETED'],'ASC','name');
        $data['remote']     = base_url().'master-data/remote/binding/';
        $page               = 'admin/master/binding_master';
        $this->header_and_footer($page, $data);
    }
    public function add_binding()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->add_data('binding_master',$data)) {
            $this->session->set_flashdata('success', 'Binding Added Successfully');
            redirect($this->agent->referrer());
        } else {
            $this->session->set_flashdata('error', 'Something Went Wrong!!');
            redirect($this->agent->referrer());
    ...
    public function edit_binding()
    {
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->edit_data('binding_master',$id,$data)) {
            $this->session->set_flashdata('success', 'Binding Edited Successfully');
            redirect($this->agent->referrer());
        } else {
            redirect($this->agent->referrer());
        }
    ...
    {
        $id = $this->uri->segment(2);
        if ($this->master_model->delete_data('binding_master',$id)) {
            $this->session->set_flashdata('success', 'Binding Deleted Successfully');
            redirect($this->agent->referrer());
        } else {
            $this->session->set_flashdata('error', 'Something Went Wrong!!');
            redirect($this->agent->referrer());
    ...
    public function change_binding_status()
    {
        $id = $this->input->post('id');
        $data['status_data'] = $this->master_model->get_row_data('binding_master','id',$id);
        ...
        $this->master_model->edit_data('binding_master',$id,$data1);
        $this->load->view('admin/statusview',$data);
        
    }

    // Book Condition Master
    public function book_condition_master()
    {
        $data['menu_id'] = $this->uri->segment(2);
        $data['title']      = 'Book Condition Master';
        $data['book_condition']      = $this->master_model->getData('book_condition_master',['is_deleted'=>'NOT_DELETED'],'ASC','name');
        $data['remote']     = base_url().'master-data/remote/book_condition/';
        $page               = 'admin/master/book_condition_master';
        $this->header_and_footer($page, $data);
    }
    public function add_book_condition()
    {
        $data = array(
            'name'     => $this->input->post('name'),
        );
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->add_data('book_condition_master',$data)) {
            $this->session->set_flashdata('success', 'Book Condition Added Successfully');
            redirect($this->agent->referrer());
        } else {
            $this->session->set_flashdata('error', 'Something Went Wrong!!');
            redirect($this->agent->referrer());
    ...
    public function edit_book_condition()
    {
        $id = $this->uri->segment(2);
        $data = array(
            'name'     => $this->input->post('name'),
        ...
        $this->form_validation->set_rules('name', 'Name', 'required');
        if ($this->master_model->edit_data('book_condition_master',$id,$data)) {
            $this->session->set_flashdata('success', 'Book Condition Edited Successfully');
            redirect($this->agent->referrer());
        } else {
            redirect($this->agent->referrer());
        }
    }   
    public function delete_book_condition()
    {
        $id = $this->uri->segment(2);
        if ($this->master_model->delete_data('book_condition_master',$id)) {
            $this->session->set_flashdata('success', 'Book Condition Deleted Successfully');
            redirect($this->agent->referrer());
        } else {
            $this->session->set_flashdata('error', 'Something Went Wrong!!');
            redirect($this->agent->referrer());
    ...
    public function change_book_condition_status()
    {
        $id = $this->input->post('id');
        $data['status_data'] = $this->master_model->get_row_data('book_condition_master','id',$id);
        ...
        $this->master_model->edit_data('book_condition_master',$id,$data1);
        $this->load->view('admin/statusview',$data);
