...
$route['author-master/(:num)'] 	= 'master/author_master';
$route['add-author'] 			= 'master/add_author';
$route['edit-author/(:num)'] 	= 'master/edit_author';
$route['delete-author/(:num)'] 	= 'master/delete_author';

$route['publisher-master/(:num)'] 	= 'master/publisher_master';
$route['add-publisher'] 			= 'master/add_publisher';
$route['edit-publisher/(:num)'] 	= 'master/edit_publisher';
$route['delete-publisher/(:num)'] 	= 'master/delete_publisher';

$route['board-master/(:num)'] 	= 'master/board_master';
$route['add-board'] 			= 'master/add_board';
$route['edit-board/(:num)'] 	= 'master/edit_board';
$route['delete-board/(:num)'] 	= 'master/delete_board';

$route['class-master/(:num)'] 	= 'master/class_master';
$route['add-class'] 			= 'master/add_class';
$route['edit-class/(:num)'] 	= 'master/edit_class';
$route['delete-class/(:num)'] 	= 'master/delete_class';

$route['subject-master/(:num)'] 	= 'master/subject_master';
$route['add-subject'] 				= 'master/add_subject';
$route['edit-subject/(:num)'] 		= 'master/edit_subject';
$route['delete-subject/(:num)'] 	= 'master/delete_subject';

$route['binding-master/(:num)'] 	= 'master/binding_master';
$route['add-binding'] 				= 'master/add_binding';
$route['edit-binding/(:num)'] 		= 'master/edit_binding';
$route['delete-binding/(:num)'] 	= 'master/delete_binding';

$route['book-condition-master/(:num)'] 		= 'master/book_condition_master';
$route['add-book-condition'] 				= 'master/add_book_condition';
$route['edit-book-condition/(:num)'] 		= 'master/edit_book_condition';
$route['delete-book-condition/(:num)'] 		= 'master/delete_book_condition';
...
$route['cancellation-exchange-orders'] = 'orders/cancellation_exchange_orders';
$route['cancellation-exchange-orders/(:any)'] = 'orders/cancellation_exchange_orders/$1';
$route['cancellation-exchange-orders/(:any)/(:any)'] = 'orders/cancellation_exchange_orders/$1/$2';
