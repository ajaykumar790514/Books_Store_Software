...
<div class="row">
        ...
        <div class="col-3">
            <div class="form-group">
                ...
                <select class="form-control" style="width:100%;" name="class" onchange="fetch_products_by_class(this.value)">
                    <option value="">Select</option>
                        <?php foreach ($class as $scat) { ?>
                        <option value="<?php echo $scat->id; ?>" <?php if(!empty($classv)) { if($classv==$scat->id) {echo "selected"; } }?>>
                            <?php echo $scat->name; ?>
                        </option>
                        <?php } ?>
                </select>
        ...
        <div class="col-3">
            <div class="form-group">
                ...
                <select class="form-control" style="width:100%;" name="subject"  onchange="fetch_products_by_subject(this.value)">
                    <option value="">Select</option>
                        <?php foreach ($subject as $scat) { ?>
                        <option value="<?php echo $scat->id; ?>" <?php if(!empty($subjectv)) { if($subjectv==$scat->id) {echo "selected"; } }?>>
                            <?php echo $scat->name; ?>
                        </option>
                        <?php } ?>
                </select>
    ...
    <div id="grid_table">
        <table class="jsgrid-table">
            <tr class="jsgrid-header-row">
                ...
                <th class="jsgrid-header-cell jsgrid-align-center">Other Options</th>
                <th class="jsgrid-header-cell jsgrid-align-center">SKU</th>
                <th class="jsgrid-header-cell jsgrid-align-center">Product Name</th>
                <th class="jsgrid-header-cell jsgrid-align-center">Publisher</th>
            ...
            <tr class="jsgrid-filter-row">
                ...
                <td class="jsgrid-cell jsgrid-align-center">
                    <?php 
                    echo $value->isbn.'<br>'.'('.$value->isbn_no.')';
                ...
                <td class="jsgrid-cell jsgrid-align-center"><?php echo $value->publisher_name;?></td>
                <td class="jsgrid-cell jsgrid-align-center"><strong>Qty.</strong>(<?=$value->qty;?>)<br><strong>MRP.</strong>(<?=$value->mrp;?>)<br><strong>Selling Rate.</strong>(<?=$value->selling_rate;?>)</td>
                ...
                <td class="jsgrid-cell jsgrid-align-center" id="status<?php echo $value->id; ?>">
                    ...
                    <br>
                    Modified<br>
                    <?=date('d-m-Y', strtotime($value->updated));?>
                </td>
...
<script type="text/javascript">
   function fetch_products(cat_id) 
   {
    ...
    var subjectv = $('[name=subject]').val();
    var classv = $('[name=class]').val();
        $.ajax({
   ...
   function fetch_products_by_class(classv)
   {
    var parent_id = $('#parent_id').val();
    var search = $('#tb-search').val();
    var parent_cat_id = $('#parent_cat_id').val();
   ...
   function fetch_products_by_subject(subjectv)
   {
    var parent_id = $('#parent_id').val();
    var search = $('#tb-search').val();
    var parent_cat_id = $('#parent_cat_id').val();
