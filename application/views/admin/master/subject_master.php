                                    ...
                                    <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div class="float-right col-md-2 col-lg-2 col-sm-12">
                                                <div id="add-subject" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" action="<?php echo base_url('add-subject'); ?>" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                ...
                                                <button class="float-right btn btn-primary" data-toggle="modal" data-target="#add-subject" >Add Subject</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div id="grid_table">
                                            <table class="jsgrid-table">
                                                ...
                                                <?php $i=1; foreach($subject as $value){ ?>
                                                <tr class="jsgrid-filter-row">
                                                    ...
                                                    <td class="jsgrid-cell jsgrid-align-center">
                                                    <a  data-toggle="modal" href="#" data-target="#edit-subject<?php echo $value->id; ?>" ><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo base_url('delete-subject/' . $value->id); ?>" onclick="return confirm('Do you want to delete this?')"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr> 
                                                <div id="edit-subject<?php echo $value->id; ?>" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <b>Update Subject</b>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url('edit-subject/'.$value->id); ?>" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Subject Name</label>
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('master-data/change_subject_status'); ?>",
        method: "POST",
        data: {
            id:id
        },
