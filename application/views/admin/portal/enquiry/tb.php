    ...
    <div id="grid_table">
        <table class="jsgrid-table">
            <tr class="jsgrid-header-row">
                ...
                <th class="jsgrid-header-cell jsgrid-align-center">Date</th>
            </tr>
            ...
            <tr class="jsgrid-filter-row">
                ...
                <th class="jsgrid-cell jsgrid-align-center"> <button class="btn-sm btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Update Status ( <?=$value->name;?> )" data-url="<?=$new_url;?><?=$value->id;?>" ><?=$value->status;?></button></th>
                <th class="jsgrid-cell jsgrid-align-center"><?php $date = $value->date;
                                                    echo   $day = date('D, F d, Y', strtotime($date));;?></th>
            </tr> 
            <!--Read Message modal-->
