...
<!-- onload="window.print()" -->
    ...
    echo $timestring = $now->format('d-m-Y');?></b>
       ...
       <hr>
       <?php 
            $address = $invoice[0]['houseNo'].' &nbsp;'.$invoice[0]['order_address'].'&nbsp; '.$invoice[0]['order_flor'].' &nbsp;'.$invoice[0]['order_apartment_name'].' <br> '.$invoice[0]['order_state'].'&nbsp;'.$invoice[0]['order_city']  .' '. $invoice[0]['order_pincode'];
       ...
       <table width="100%">
        ...
        <th style="border:2px solid black;height:40px;width:40px;font-family:  Arial, Helvetica, sans-serif;">Cancel Items.</th>
		...
		<th style="border:2px solid black;height:40px;width:80px;font-family:  Arial, Helvetica, sans-serif;"><center style="margin-top: 0.7rem;">Disc. <br>[%]</center></th>
        ...
        <?php
          // discount
            ...
            <tr>
                ...
                <td style="border:2px solid black;height:40px;width:65.5px;text-align:center;font-family:  Arial, Helvetica, sans-serif;"><?php if($row['is_cancel']=='1'){ echo $row['cancel_qty'];}else{echo "N/A";};?></td>
                <td  style="border:2px solid black;height:40px;width:130px;text-align:center;font-family:  Arial, Helvetica, sans-serif;">₹<?= $row['mrp']; ?>
                <td style="border:2px solid black;height:40px;width:80px;text-align:center;font-family:  Arial, Helvetica, sans-serif;"><?php echo round(($discount),2)?>%</td>
                <td style="border-right:5px !important;border:2px solid black;height:40px;width:80px;text-align:center;font-family:  Arial, Helvetica, sans-serif;">₹<?php echo number_format((float)($row['total_price']), 2, '.', ''); ?></td>
            </tr>
		  <?php
            $i=$i+1;
            endforeach;
       ...
       <?php
       if($invoice[0]['is_cancel']=='1'){
         $oneitemtax =  number_format((float)$invoice[0]['tax_value']/$invoice[0]['qty'], 2, '.', '');
       }else
       {
        $oneitemtax=0;
       }
        if($invoice[0]['order_state'] == $invoice[0]['primary_state'])
        {
            $igst = $invoice[0]['order_tax']-$oneitemtax;
            $cgst = '0';
            $sgst = '0';
            $igst_per = $invoice[0]['tax_value']-$oneitemtax;
            $cgst_per = '0';
            $sgst_per = '0';
        }
        else
        {
            $igst = '0';
            $cgst = ($invoice[0]['order_tax']-$oneitemtax)/2;
            $sgst = ($invoice[0]['order_tax']-$oneitemtax)/2;
            $igst_per = '0';
            $cgst_per = ($invoice[0]['tax_value']-$oneitemtax)/2;
            $sgst_per = ($invoice[0]['tax_value']-$oneitemtax)/2;
        } 
      
        ?>
		<table width="100%">
        <tr>
				<td style="width:760px;border-top:3px !important;border-left:3px !important;border-bottom:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">Total Cancel Items Amount</td>
                <td style="width:150px;border-top:3px !important;border-right:3px !important;border-bottom:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">₹ <?php echo number_format((float)($invoice[0]['cancel_amount']-$oneitemtax), 2, '.', '');?></td>
			</tr>
            <tr>
			...
			<tr>
				<td style="width:760px;border-top:3px !important;border-left:3px !important;border-bottom:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">COD Charges</td>
			...
			<tr>
                ...
                <td style="width:184px;border-top:3px !important;border-right:3px !important;border-bottom:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">₹<?php echo number_format((float)(($invoice[0]['total_value']-$invoice[0]['order_tax'])-$invoice[0]['cancel_amount']+$oneitemtax), 2, '.', '');?></td>
			</tr>
			<tr>
				<td style="width:760px;border-top:3px !important;border-left:3px !important;border-bottom:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">CGST ( @ 0% ) </td>
            ...
            <tr>
				<td style="width:760px;border-top:3px !important;border-left:3px !important;border-bottom:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">SGST ( @ 0% )</td>
			...
			<tr>
				<td style="width:760px;border-top:3px !important;border-left:3px !important;border-bottom:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">IGST ( @ 0% )</td>
			...
			<tr>
                ...
                <th style="width:184px;border-top:3px !important;border-right:3px !important;border:2px solid black;text-align:right;font-family:  Arial, Helvetica, sans-serif;">₹<?php  echo number_format((float)($invoice[0]['total_value']-$invoice[0]['cancel_amount']), 2, '.', ''); ?></th>
			</tr>
		</table>
        <div id="total-amount">
		  	<p>Total Amount (in words) : <strong>INR <?= number_to_word($invoice[0]['total_value']-$invoice[0]['cancel_amount']); ?></strong></p>
		</div>
        <hr>
        <div style="text-align: end">
            <p id="authorised">For My Books Deal</p>
