	...
	<div id="page-wrap">
		...
		<div id="company-details">
            <div class="row" id="head">
                ...
                <p style="font-size:1.2rem"><?=$invoice[0]['order_address']. ','.$invoice[0]['order_flor']. ','.$invoice[0]['order_apartment_name'];?> </p>
                <p style="font-size:1.2rem"><?=$invoice[0]['order_state'].',&nbsp;'.$invoice[0]['order_city'].', &nbsp;'.$invoice[0]['order_pincode'];?></p>
        ...
        <th style="border: 3px solid #000;text-align:center;width:8%;font-family:  Arial, Helvetica, sans-serif">Cancel Items.</th>
                    <th style="border: 3px solid #000;text-align:center;width:10%;font-family:  Arial, Helvetica, sans-serif">MRP <br>[Rs.Ps.]</th>
                    <th style="border: 3px solid #000;text-align:center;width:10%;font-family:  Arial, Helvetica, sans-serif">Disc. <br>[%]</th>
          ...
          // discount
			...
			?>
                <tr>
                    ...
                    <td style="border: 3px solid #000;text-align:center;font-family:  Arial, Helvetica, sans-serif"><?=$row['qty'];?></td>
                    <td style="border: 3px solid #000;text-align:center;font-family:  Arial, Helvetica, sans-serif"><?php if($row['is_cancel']=='1'){ echo $row['cancel_qty'];}else{echo "N/A";};?></td>
                    <td style="border: 3px solid #000;text-align:center;font-family:  Arial, Helvetica, sans-serif">₹<?= $row['mrp']; ?> </td>
                    <td style="border: 3px solid #000;text-align:center;font-family:  Arial, Helvetica, sans-serif"><?=round(($discount),2)?>%</td>
                    <td style="border: 3px solid #000;text-align:center;font-family:  Arial, Helvetica, sans-serif">₹<?php echo number_format((float)($row['total_price']), 2, '.', ''); ?> </td>
                </tr>
                <?php
            $i=$i+1;
            endforeach;
            ...
            ?>
             <?php    if($invoice[0]['is_cancel']=='1'){
                 ...
                 <tr>
                    ...
                    <p>₹<?php echo number_format((float)($invoice[0]['cancel_amount']-$oneitemtax), 2, '.', '');?></p>
                    <p>₹0.00</p>
                   
                    <p style="margin-top: 0.5rem;">₹<?php echo  number_format((float)($invoice[0]['total_value']-$invoice[0]['order_tax'])-$invoice[0]['cancel_amount']+$oneitemtax, 2, '.', '') ?></p>
                  </td>
                </tr>
